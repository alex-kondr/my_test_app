...
agent = AgentForm(
    name="review.homekitnews.com",
    )
# agent.create_run(
#     name_agent_for_test="Homekit News and Reviews [TW]",
#     agent_id="19872",
#     url='https://homekitnews.com/category/reviews/',
...
#     revs_xpath='//h2[@class="cm-entry-title"]/a',
#     name_title="title",
