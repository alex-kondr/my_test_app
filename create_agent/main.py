...
agent = AgentForm(
    name="reviews.nailpolishdirect.co.uk",
    )
agent.create_run(
    name_agent_for_test="Nailpolishdirect[UK]",
    agent_id="20095",
    url='https://www.nailpolishdirect.co.uk/',
...
agent.create_frontpage(
    cats_xpath='//li[contains(@class, "nail-polish-top-links")]',
    name_xpath='a/text()',
    url_xpath='@href'
)
