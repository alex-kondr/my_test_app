...
agent.create_revlist(
    revs_xpath='//div[h2 and contains(@class, "article-group__list")]//div[contains(@class, "article-tile__content")]//div[contains(@class, "article-tile__content-article-info-title")]/a',
