...
def process_category(data, context, session):
    ...
    if data_json:
        ...
        options = """--compressed -X PUT -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:147.0) Gecko/20100101 Firefox/147.0' -H 'Accept: application/json; charset=utf-8' -H 'Accept-Language: uk-UA,uk;q=0.9,en-US;q=0.8,en;q=0.7' -H 'Accept-Encoding: gzip, deflate, br, zstd' -H 'X-CSRF-TOKEN: 128e83b4-4dc2-41e7-b60f-7c0304c2fe23' -H 'client-route-id: 2ac03c95-b622-4a43-a51c-8492d111f569' -H 'ecom-request-source: web' -H 'ecom-request-source-version: 2.0.0-2026-02-12-09h03m25s-aa743fa3' -H 'page-view-id: 82118ad1-52e2-495c-a16b-3fb0e157cef2' -H 'content-type: application/json; charset=utf-8' -H 'Connection: keep-alive' -H 'Cookie: VISITORID=XmXgKix2txabbVDfJJy7o0veL5_ORQScUgKucEoyFkwCidJg6sdU4BGzlVoYuRO5A56YtHHKpOdvaviz_tN1GGgNOHELoXIEVCaNGw==; AWSALB=vgpfLZmH8KljEJTX4jHDppENECDc1R0PkbRuwKVMfmXqg3pzZS1kXQp9qXWMGaTejgwF7Irk3d3wLyYMfBwYGbMPwnakrV2WFP7s2Wla9wL+bPPLh8ExNgwYEwKO; AWSALBCORS=vgpfLZmH8KljEJTX4jHDppENECDc1R0PkbRuwKVMfmXqg3pzZS1kXQp9qXWMGaTejgwF7Irk3d3wLyYMfBwYGbMPwnakrV2WFP7s2Wla9wL+bPPLh8ExNgwYEwKO; OptanonConsent=isGpcEnabled=0&datestamp=Mon+Feb+16+2026+15%3A30%3A35+GMT%2B0200+(%D0%B7%D0%B0+%D1%81%D1%85%D1%96%D0%B4%D0%BD%D0%BE%D1%94%D0%B2%D1%80%D0%BE%D0%BF%D0%B5%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D0%BC+%D1%81%D1%82%D0%B0%D0%BD%D0%B4%D0%B0%D1%80%D1%82%D0%BD%D0%B8%D0%BC+%D1%87%D0%B0%D1%81%D0%BE%D0%BC)&version=202501.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&consentId=b62cbd90-562e-4eed-9135-28b58cf73009&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0003%3A1%2CC0004%3A1%2CC0002%3A1&intType=1&geolocation=UA%3B51&AwaitingReconsent=false; OptanonAlertBoxClosed=2026-02-12T11:31:20.829Z; contentExperienceUserId=6a904135-7147-4fbc-a6f7-5016b18a522e; language=en-GB; AWSALBTG=VsdAdLeLyzJT6SR6bEoi5lU58AJz4X2QewrhA/PNkRSOYoAtKu7uacs5Rnm618bGOGJS2QbKRvQwVCO8ZAFEJwCcMQo4JAIIe5MNOEJQpMuZA6uc1LmAJ+M34X6Zoztgi6yFW7pfVoZzVvbEQBC8hm6SIiEYmMriMb1hvKUnE1P6; AWSALBTGCORS=VsdAdLeLyzJT6SR6bEoi5lU58AJz4X2QewrhA/PNkRSOYoAtKu7uacs5Rnm618bGOGJS2QbKRvQwVCO8ZAFEJwCcMQo4JAIIe5MNOEJQpMuZA6uc1LmAJ+M34X6Zoztgi6yFW7pfVoZzVvbEQBC8hm6SIiEYmMriMb1hvKUnE1P6; global_sid=80wzbniI8Qo_oTPE9dpGkelrS8WENh6bymbpqTLqDOsC5rsHXn_ecgy7rdUnXIJ3K7kR5jpqJYlIhFzL1oriRMdzBRQ_ygyo0za_bQ==' -H 'Sec-Fetch-Dest: empty' -H 'Sec-Fetch-Mode: cors' -H 'Sec-Fetch-Site: same-origin' -H 'Priority: u=4' -H 'Pragma: no-cache' -H 'Cache-Control: no-cache' --data-raw '{prods_id}'""".format(prods_id=str(prods_id).replace("u'", '"').replace("'", '"'))
