...
def run(context, session):
    ...
    session.queue(Request('https://www.runnersworld.com/uk/gear/shoes/'), process_category, dict(cat='Shoes'))
    session.queue(Request('https://www.runnersworld.com/uk/gear/clothes/'), process_category, dict(cat='Clothes'))
    session.queue(Request('https://www.runnersworld.com/uk/gear/tech/'), process_category, dict(cat='Tech'))
...
def process_revlist(data, context, session):
    ...
    revs = simplejson.loads(data.content).get('data', {}).get('feedContent')
    if not revs:
        return
