...
def run(context, session):
    ...
    session.queue(Request('https://www.projectorscreen.com/blog?categories=259'), process_revlist, dict(cat='Projectors'))
    session.queue(Request('https://www.projectorscreen.com/blog?categories=186'), process_revlist, dict(cat='Movies'))
