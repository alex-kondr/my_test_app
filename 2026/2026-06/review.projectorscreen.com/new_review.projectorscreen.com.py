...
def run(context, session):
    ...
    session.queue(Request('https://www.projectorscreen.com/blog?categories=259', use='curl'), process_revlist, dict(cat='Projectors'))
    session.queue(Request('https://www.projectorscreen.com/blog?categories=186', use='curl'), process_revlist, dict(cat='Movies'))
