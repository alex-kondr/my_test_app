...
URLS = ['https://www.latercera.com/pf/api/v3/content/fetch/story-feed-sections-fetch?query={"feedOffset":offset,"feedSize":4,"fromComponent":"grid","includeSections":"/mouse","query":"/mouse","tagSlug":"/mouse"}&d=1199&mxId=00000000&_website=la-tercera', 'https://www.latercera.com/pf/api/v3/content/fetch/story-feed-sections-fetch?query={"feedOffset":offset,"feedSize":4,"fromComponent":"grid","includeSections":"/tecnologia","query":"/tecnologia","tagSlug":"/tecnologia"}&d=1199&mxId=00000000&_website=la-tercera']
...
def process_revlist(data, context, session):
    ...
    if offset < revs_cnt:
        session.queue(Request(context['cat_url'].replace('offset', str(offset))), process_revlist, dict(context, revs_cnt=revs_cnt, offset=offset))
