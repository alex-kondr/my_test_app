...
def run(context, session):
    ...
    session.queue(Request("https://groceries.morrisons.com/categories", force_charset='utf-8', use='curl'), process_catlist, dict())
...
def process_catlist(data, context, session):
    ...
    for cat in cats:
        ...
        if name not in XCAT:
            session.queue(Request(url, force_charset='utf-8', use='curl'), process_category, dict(cat=name))
...
def process_category(data, context, session):
    ...
    options = """--compressed -X PUT -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:150.0) Gecko/20100101 Firefox/150.0' -H 'Accept: application/json; charset=utf-8' -H 'Accept-Language: uk-UA,uk;q=0.9,en-US;q=0.8,en;q=0.7' -H 'Accept-Encoding: deflate' -H 'X-CSRF-TOKEN: 9fa5edae-2259-4111-9149-f8d178c57711' -H 'client-route-id: 9a65aefb-a8d8-4b2a-82a9-f1726f516a96' -H 'ecom-request-source: web' -H 'ecom-request-source-version: 2.0.0-2026-04-28-06h16m54s-e0eff4a8' -H 'page-view-id: b2abf179-6853-472d-b5d1-598b3c908e3e' -H 'content-type: application/json; charset=utf-8' -H 'Origin: https://groceries.morrisons.com' -H 'Connection: keep-alive' -H 'Cookie: global_sid=eJFVWMmaIDwE3CmvJriiuxI63R4LWMUtF4nq6OeFmklitmQ5U_FlfDHR1veJoPMfelZ7KKXBjrpqwESg3ltrb6nAbqisFwxjkVYZGg==; VISITORID=bQbcc5OhRE5kMu-NmXoXutNv-qaA9UOzxxLm_ocEVUYEGRWgWZZdI3EVirr0j-fy4IKDvs3Hm5WzoM0D0xFisTFyf7cjzHMeTNA_Vw==; AWSALB=5ln0PfMLHLWbW/o/5L2L4Cec6gGX0CaPELhb2LCxFi7zIUluIhaBk+avsrVlFw6Z7UXZ5pYlEtsLNmw5autaHgRJrMK6fCPNOhTPZoJNPGF06aV427XOv0aJRNRG; AWSALBCORS=5ln0PfMLHLWbW/o/5L2L4Cec6gGX0CaPELhb2LCxFi7zIUluIhaBk+avsrVlFw6Z7UXZ5pYlEtsLNmw5autaHgRJrMK6fCPNOhTPZoJNPGF06aV427XOv0aJRNRG; OptanonConsent=isGpcEnabled=0&datestamp=Thu+Apr+30+2026+10%3A45%3A42+GMT%2B0300+(%D0%B7%D0%B0+%D1%81%D1%85%D1%96%D0%B4%D0%BD%D0%BE%D1%94%D0%B2%D1%80%D0%BE%D0%BF%D0%B5%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D0%BC+%D0%BB%D1%96%D1%82%D0%BD%D1%96%D0%BC+%D1%87%D0%B0%D1%81%D0%BE%D0%BC)&version=202501.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&consentId=3676f749-cb1c-4d21-8604-bb4f50204cc4&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0003%3A1%2CC0004%3A1%2CC0002%3A1&intType=1&geolocation=UA%3B30&AwaitingReconsent=false; OptanonAlertBoxClosed=2026-04-30T07:31:33.555Z; contentExperienceUserId=a0c93a48-7051-4bb5-96ca-28d7b19d11d6; language=en-GB' -H 'Sec-Fetch-Dest: empty' -H 'Sec-Fetch-Mode: cors' -H 'Sec-Fetch-Site: same-origin' -H 'Priority: u=4' -H 'Pragma: no-cache' -H 'Cache-Control: no-cache' --data-raw '{prods_id}'""".format(prods_id=str(prods_id).replace("u'", '"').replace("'", '"'))
