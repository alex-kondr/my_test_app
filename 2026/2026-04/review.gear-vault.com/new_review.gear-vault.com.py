...
def run(context, session):
    session.queue(Request("https://gear-vault.com/guitars/", use='curl', max_age=0), process_revlist, dict(cat='Guitars'))
    session.queue(Request("https://gear-vault.com/amplifiers/", use='curl', max_age=0), process_revlist, dict(cat='Amplifiers'))
