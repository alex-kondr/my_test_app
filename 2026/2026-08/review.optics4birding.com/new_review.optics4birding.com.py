...
def run(context: dict[str, str], session: Session):
    ...
    session.queue(Request('https://optics4birding.com/pages/expert-reviews', force_charset='utf-8'), process_revlist, dict())
...
def process_revlist(data: Response, context: dict[str, str], session: Session):
    ...
    for cat in cats:
        ...
        for rev in revs:
            ...
            session.queue(Request(url, force_charset='utf-8'), process_review, dict(cat=cat_name, title=title, url=url))
