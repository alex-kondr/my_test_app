...
def run(context: dict[str, str], session: Session):
    ...
    session.queue(Request('https://bjorn3d.com/category/reviews-articles/'), process_revlist, {})
...
def process_review(data: Response, context: dict[str, str], session: Session):
    ...
    if pages:
        ...
        session.do(Request(page_url), process_review_last, dict(excerpt=excerpt, review=review, product=product, pages=True))
