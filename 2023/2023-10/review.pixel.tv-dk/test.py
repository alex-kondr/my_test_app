...
test.test_product_name(xproduct_names=['Anmeldelse'], not_xproduct_name="", len_name=3)
...
test.test_review_excerpt(["Konklusion", "Udvikler", "Udgiver", "platforme:"], len_chank=100, len_excerpt=10)
