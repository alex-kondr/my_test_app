...
test.test_product_name(xproduct_names=['god'], not_xproduct_name="", len_name=8)
test.test_product_category(xproduct_names=["rekommenderar", "artikel", "toppklass", "nyheter", "jämförande", "topphändelser", "reportage"])
