...
def process_category(data, context, session):
    ...
    prods_url = 'https://groceries.morrisons.com/api/webproductpagews/v6/product-pages?includeAdditionalPageInfo=true&maxPageSize=300&maxProductsToDecorate=50&retailerCategoryId=176738&sortOptionId=favorite&tag=web&tag=category-item'

    # options = """--compressed -X PUT -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:151.0) Gecko/20100101 Firefox/151.0' -H 'Accept: application/json; charset=utf-8' -H 'Accept-Language: uk-UA,uk;q=0.9,en-US;q=0.8,en;q=0.7' -H 'Accept-Encoding: deflate' -H 'X-CSRF-TOKEN: cbfe4d8a-3bd6-4b19-acaf-c46480500851' -H 'client-route-id: 3088d8ff-536e-447f-a8f0-75f5a86b5442' -H 'ecom-request-source: web' -H 'ecom-request-source-version: 2.0.0-2026-06-05-16h20m47s-1a15f03b' -H 'page-view-id: 1feca23d-9089-4d0c-a3e3-356376ecf1f2' -H 'content-type: application/json; charset=utf-8' -H 'Connection: keep-alive' -H 'Cookie: global_sid=Zt6sB9OYSVxftRTC6jFQIWOoEvYJYTuundTw_5db1Z6L2IMXLXAmVLnawvCsVkDOAff0KVgCl60vZgHr9y-N43BsQuudy8f3E_bP7Q==; VISITORID=Cnoqsxnn_id0DxSaYxHZwgCU_djou7Ek8YoGXC7PKN4PXs7OPXXb1wl7rQozXhqnIFXldcn75vr846vs1dU-hkuqg_H45LpXY2-2Fg==; AWSALB=dRWLtGYp0NQvPfNd9RW8iuSpfosQkshBm2FCaUZQ2hNiQh9dJrtgoQHM44zsBKpc8P9AjZY/3POimq7NQCNy655XeXmCcu3ZXbpXH4yUI7JldEnDkQLZKCEVbRbR; AWSALBCORS=dRWLtGYp0NQvPfNd9RW8iuSpfosQkshBm2FCaUZQ2hNiQh9dJrtgoQHM44zsBKpc8P9AjZY/3POimq7NQCNy655XeXmCcu3ZXbpXH4yUI7JldEnDkQLZKCEVbRbR; OptanonConsent=isGpcEnabled=0&datestamp=Mon+Jun+08+2026+15%3A10%3A22+GMT%2B0300+(%D0%B7%D0%B0+%D1%81%D1%85%D1%96%D0%B4%D0%BD%D0%BE%D1%94%D0%B2%D1%80%D0%BE%D0%BF%D0%B5%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D0%BC+%D0%BB%D1%96%D1%82%D0%BD%D1%96%D0%BC+%D1%87%D0%B0%D1%81%D0%BE%D0%BC)&version=202501.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&consentId=817c0ad3-03fe-41e2-b4de-2d00be72f428&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0003%3A1%2CC0004%3A1%2CC0002%3A1&intType=1&geolocation=UA%3B30&AwaitingReconsent=false; OptanonAlertBoxClosed=2026-06-08T08:34:00.191Z; contentExperienceUserId=8690b9ff-8d83-42bf-bde0-375947bd46f2; language=en-GB' -H 'Sec-Fetch-Dest: empty' -H 'Sec-Fetch-Mode: cors' -H 'Sec-Fetch-Site: same-origin' -H 'Priority: u=4' -H 'Pragma: no-cache' -H 'Cache-Control: no-cache' -H 'TE: trailers' --data-raw '{prods_id}'""".format(prods_id=str(prods_id).replace("u'", '"').replace("'", '"'))
