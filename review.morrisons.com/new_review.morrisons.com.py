...
def process_category(data, context, session):
    ...
    if data_json:
        ...
        options = """--compressed -X PUT -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:147.0) Gecko/20100101 Firefox/147.0' -H 'Accept: application/json; charset=utf-8' -H 'Accept-Language: uk-UA,uk;q=0.9,en-US;q=0.8,en;q=0.7' -H 'Accept-Encoding: deflate' -H 'X-CSRF-TOKEN: d2246486-4dea-404a-9083-8ca2eeb266b9' -H 'client-route-id: e8d1fb2e-d38f-4eb7-a85a-f1aa8f209f0e' -H 'ecom-request-source: web' -H 'ecom-request-source-version: 2.0.0-2026-02-12-09h03m25s-aa743fa3' -H 'page-view-id: 114bb51b-cf11-4ebd-a423-a7086a8e1885' -H 'content-type: application/json; charset=utf-8' -H 'Connection: keep-alive' -H 'Cookie: VISITORID=qiiXmAm1IfbPKvrpjyfoOgei04bVWsYKz3QuIUeZw0VxFx4cPRk0NRrvZ5BUw1ShIp5NBO4-8IsnpDX2fG4cSef1b5l1Gwl9YklJDA==; AWSALB=jcX+TeH8v+WUrpRPsGgj05pFjQKaDdKKzcTdgFT8KSYyemLgIuNfVxrEhzbQEoqIgESLcGP/zWHrLq4mxQMspCmSxpuoAwIDS0+v3lT8EfpyaZZl6Ifp4Q1UAh1t; AWSALBCORS=jcX+TeH8v+WUrpRPsGgj05pFjQKaDdKKzcTdgFT8KSYyemLgIuNfVxrEhzbQEoqIgESLcGP/zWHrLq4mxQMspCmSxpuoAwIDS0+v3lT8EfpyaZZl6Ifp4Q1UAh1t; OptanonConsent=isGpcEnabled=0&datestamp=Sun+Feb+15+2026+20%3A37%3A52+GMT%2B0200+(%D0%B7%D0%B0+%D1%81%D1%85%D1%96%D0%B4%D0%BD%D0%BE%D1%94%D0%B2%D1%80%D0%BE%D0%BF%D0%B5%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D0%BC+%D1%81%D1%82%D0%B0%D0%BD%D0%B4%D0%B0%D1%80%D1%82%D0%BD%D0%B8%D0%BC+%D1%87%D0%B0%D1%81%D0%BE%D0%BC)&version=202501.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&consentId=9e5b6786-5ba3-4d52-94c8-f00355089f13&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0003%3A1%2CC0004%3A1%2CC0002%3A1&intType=1&geolocation=UA%3B30&AwaitingReconsent=false; OptanonAlertBoxClosed=2026-02-13T11:03:13.045Z; contentExperienceUserId=58a2d1a1-b232-48e3-9d8a-9c7cb4295689; language=en-GB; global_sid=k0iE-r4KqL1LmhRgWfxaSewuPWfcCLofWv5XAtMP-K1keekpcOiprwGcFbr8waa5p5i1H6gxrMeZ4k9B29pkPYi3X7Iiu6Zmexe4rQ==' -H 'Sec-Fetch-Dest: empty' -H 'Sec-Fetch-Mode: cors' -H 'Sec-Fetch-Site: same-origin' -H 'Priority: u=4' -H 'Pragma: no-cache' -H 'Cache-Control: no-cache' --data-raw '{prods_id}'""".format(prods_id=str(prods_id).replace("u'", '"').replace("'", '"'))
