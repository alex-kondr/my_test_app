...
def process_category(data, context, session):
    ...
    options = """--compressed -X PUT -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:148.0) Gecko/20100101 Firefox/148.0' -H 'Accept: application/json; charset=utf-8' -H 'Accept-Language: uk-UA,uk;q=0.9,en-US;q=0.8,en;q=0.7' -H 'Accept-Encoding: deflate' -H 'X-CSRF-TOKEN: f567bee4-479f-4153-9bcc-81b7950a5ca9' -H 'client-route-id: 6cedaebf-9757-41f5-af8e-f899f2500739' -H 'ecom-request-source: web' -H 'ecom-request-source-version: 2.0.0-2026-03-23-08h46m48s-2463eb6f' -H 'page-view-id: f6d61560-0b6f-49d0-8e1c-742b8806f03f' -H 'content-type: application/json; charset=utf-8' -H 'Origin: https://groceries.morrisons.com' -H 'Connection: keep-alive' -H 'Cookie: VISITORID=6S6Mazrp0XHWyj3BRJfNWIz-SilZfas-0IgDf1neOooKMckjvS9WhfKE4dHJXTIkTmgGUILIkvwBcZXfc07BUtGyDEMt_9Fs_PqX_A==; contentExperienceUserId=58a2d1a1-b232-48e3-9d8a-9c7cb4295689; language=en-GB; global_sid=oXBf2IfvYYvpWI6ev9eqINGWY7sHdX3keEsHqdLE35K4cebcngY-l65uRIE94Wh8SUh2T9yGW7ZHsBsPso_QTY8movjQyVYFYag0Rw==; AWSALB=ZWb+36GlImmJ7XF2C33/w7IrbCURPvrVZAucnYowGJaX7OLWMclsN4qiNm2J9uDDRQb9OiQrKnFhr97FptYQbd39ni59qXSYpDUhwmEdac08065L481n2Dm49q4Q; AWSALBCORS=ZWb+36GlImmJ7XF2C33/w7IrbCURPvrVZAucnYowGJaX7OLWMclsN4qiNm2J9uDDRQb9OiQrKnFhr97FptYQbd39ni59qXSYpDUhwmEdac08065L481n2Dm49q4Q; OptanonConsent=isGpcEnabled=0&datestamp=Tue+Mar+24+2026+08%3A32%3A46+GMT%2B0200+(%D0%B7%D0%B0+%D1%81%D1%85%D1%96%D0%B4%D0%BD%D0%BE%D1%94%D0%B2%D1%80%D0%BE%D0%BF%D0%B5%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D0%BC+%D1%81%D1%82%D0%B0%D0%BD%D0%B4%D0%B0%D1%80%D1%82%D0%BD%D0%B8%D0%BC+%D1%87%D0%B0%D1%81%D0%BE%D0%BC)&version=202501.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&consentId=2ca4bb6c-0fcd-4124-82ce-fd029a98674e&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0003%3A1%2CC0004%3A1%2CC0002%3A1&intType=1&geolocation=UA%3B51&AwaitingReconsent=false; OptanonAlertBoxClosed=2026-03-24T06:12:27.547Z' -H 'Sec-Fetch-Dest: empty' -H 'Sec-Fetch-Mode: cors' -H 'Sec-Fetch-Site: same-origin' -H 'Priority: u=4' -H 'Pragma: no-cache' -H 'Cache-Control: no-cache' --data-raw '{prods_id}'""".format(prods_id=str(prods_id).replace("u'", '"').replace("'", '"'))
