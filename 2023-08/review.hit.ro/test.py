...
test.test_review_conclusion(["Sursa:", "Surse:", "Specificatii ", "Specificații"])
test.test_review_excerpt(["Sursa:", "Surse:", "Specificatii ", "Specificații"], len_chank=200, len_excerpt=10)
