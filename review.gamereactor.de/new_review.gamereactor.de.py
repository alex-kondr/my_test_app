...
def run(context: dict[str, str], session: Session):
    ...
    session.queue(Request('https://www.gamereactor.de/', force_charset='utf-8', max_age=0), process_frontpage, dict())
    session.queue(Request('https://www.gamereactor.de/Kritiken/', force_charset='utf-8', max_age=0), process_revlist, dict())
    session.queue(Request('https://www.gamereactor.de/Film/', force_charset='utf-8', max_age=0), process_revlist, dict(cat='Film'))
    session.queue(Request('https://www.gamereactor.de/series/', force_charset='utf-8', max_age=0), process_revlist, dict(cat='Series'))
