...
def run(context, session):
    ...
    session.queue(Request('https://www.eurogamer.net/reviews'), process_revlist, dict())
...
def process_review(data, context, session):
    ...
    if next_url:
        ...
        session.do(Request(next_url), process_review_next, dict(grade_overall=grade_overall, excerpt=excerpt, review=review, product=product, page=2))
