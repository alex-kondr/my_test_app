...
def run(context: dict[str, str], session: Session):
    ...
    session.queue(Request('https://www.eurogamer.net/reviews', force_charset='utf-8'), process_revlist, dict())
...
def process_review(data: Response, context: dict[str, str], session: Session):
    ...
    if next_url:
        ...
        session.do(Request(next_url, force_charset='utf-8'), process_review_next, dict(grade_overall=grade_overall, excerpt=excerpt, review=review, product=product, page=2))
