...
agent_id = agents.DIGITAL_PRO_SOUND


with open("review.digitalprosound.digitalmedianet.com/new_review.digitalprosound.digitalmedianet.com.py", "r", encoding="utf-8") as file:
