...
def run(context, session):
        ...
        session.queue(Request("http://www.senses.se/", use='curl', force_charset='utf-8', max_age=0), process_frontpage, dict())
...
def process_revlist(data, context, session):
    ...
    for rev in revs:
        ...
        session.queue(Request(url, use='curl', force_charset='utf-8', max_age=0), process_review, dict(context, title=title, url=url, ssid=ssid))
