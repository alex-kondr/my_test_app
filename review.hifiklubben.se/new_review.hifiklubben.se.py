...
XCATS = ['Kablar', 'Välkommen till Vinyl', 'Hur använder jag vinylspelaren?', 'Projektordukar']
...
def run(context, session):
    ...
    session.queue(Request('https://www.hifiklubben.se'), process_frontpage, dict())
    ...
    for cat in cats:
        ...
        if name not in XCATS:
            ...
            for sub_cat in sub_cats:
                ...
                if ' alla ' not in sub_name and sub_name not in XCATS:
