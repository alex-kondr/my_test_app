...
def process_review(data, context, session):
    ...
    if not excerpt:
        excerpt = data.xpath('//div[contains(@class, "article__body")]/p[not(contains(., "Grab your copy here") or strong[contains(., "VITALS")])]//text()[not(regexp:test(., "^.+:|www."))]').string(multiple=True)
