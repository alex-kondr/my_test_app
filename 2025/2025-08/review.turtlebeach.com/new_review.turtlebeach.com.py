...
def run(context, session):
    ...
    session.queue(Request('https://www.turtlebeach.com/collections/all-products'), process_catlist, dict())
...
def process_catlist(data, context, session):
    ...
    for cat in cats:
        ...
        session.queue(Request(url), process_prodlist, dict(cat=name, cat_id=cat_id))
