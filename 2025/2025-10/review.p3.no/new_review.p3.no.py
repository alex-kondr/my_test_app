...
def run(context, session):
    ...
    session.queue(Request('https://p3.no/category/tv/', max_age=0), process_revlist, dict(cat='TV-serier'))
    session.queue(Request('https://p3.no/category/film/', max_age=0), process_revlist, dict(cat='Film'))
    session.queue(Request('https://p3.no/category/spill/', max_age=0), process_revlist, dict(cat='Spill'))
