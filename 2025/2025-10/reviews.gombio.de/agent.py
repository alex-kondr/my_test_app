...
XCAT = ['Unsere Topseller', 'Handy mit Vertrag', 'Handytarife', 'Kundenservice', 'Apple Refurbished', 'Tablet mit Vertrag', 'Datentarife']
...
def process_frontpage(data, context, session):
    ...
    for cat in cats:
        ...
        if name and name not in XCAT:
            sub_cats = cat.xpath('.//ul[not(contains(., "Beliebte"))]/li[not(contains(@class, "title"))]/a')
