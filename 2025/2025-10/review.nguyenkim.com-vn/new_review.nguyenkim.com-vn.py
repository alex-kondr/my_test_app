...
def run(context, session):
    ...
    session.queue(Request("https://www.nguyenkim.com", max_age=0), process_frontpage, dict())
...
def process_reviews(data, context, session):
    ...
    if next_url:
        ...
        session.do(Request(url, force_charset='utf-8', max_age=0), process_reviews, dict(product=product))
