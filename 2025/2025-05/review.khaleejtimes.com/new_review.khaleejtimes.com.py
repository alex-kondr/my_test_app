...
def process_review(data, context, session):
    ...
    rev_json = data.xpath('//script[contains(., "window.initialPage =")]/text()').string()
    if not rev_json:
        return
    ...
    rev_json = simplejson.loads(rev_json.replace('window.initialPage = ', '').strip(' ;.+-*')).get('props', {}).get('story_data', {})
