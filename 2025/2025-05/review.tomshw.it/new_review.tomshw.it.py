...
def process_review(data, context, session):
    ...
    grade_overall = data.xpath('count(//div[contains(@class, "md:flex")]/svg[contains(@class, "text-red-500")])')
    if grade_overall:
    ...
    if not pros:
        pros = data.xpath('//li[contains(., "Pro")]/ul/li')
    ...
    if not cons:
        cons = data.xpath('//li[contains(., "Contro")]/ul/li')
