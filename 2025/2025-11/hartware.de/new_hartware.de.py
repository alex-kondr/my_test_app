...
def run(context, session):
    ...
    session.queue(Request('https://www.hartware.de/category/reviews/', use='curl'), process_revlist, dict())
...
def process_revlist(data, context, session):
    ...
    #     time.sleep(1)
    #     session.do(Request('https://www.hartware.de/category/reviews/', use='curl', force_charset='utf-8', options=OPTIONS), process_revlist, dict())
    #     return
