...
def get_token(data: Response, context: dict[str, str], session: Session):
...
def run(context: dict[str, str], session: Session):
    ...
    session.queue(Request("https://store.blackview.hk", force_charset='utf-8', use='curl'), process_frontpage, dict())
