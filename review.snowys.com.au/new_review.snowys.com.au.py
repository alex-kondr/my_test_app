...
def run(context, session):
    ...
    session.queue(Request("https://www.snowys.com.au/", force_charset='utf-8'), process_frontpage, dict())
        ...
        if sub_cats:
            for sub_cat in sub_cats:
                ...
                if sub_cats1:
                    ...
                    session.queue(Request(url, force_charset='utf-8'), process_prodlist, dict(cat=name + '|' + sub_name))
        else:
