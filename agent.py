...
class Request:
    def __init__(self, url: str, use: Literal['curl', None] = None, force_charset: Literal['utf-8', 'cp1252', None] = None, max_age: Literal[0, None] = None, options: Optional[str] = None, method: Optional[Literal["POST"]]=None, data: Optional[dict]=None):
        pass
...
class NodeSet:
    ...
    def first(self, default=None) -> "NodeSet":...
    # opposite of first
    def last(self, default=None) -> "NodeSet":...
