...
def process_review(data, context, session):
    ...
    if not excerpt:
        excerpt = data.xpath('//div[article]/div/p[not(contains(em, "Disclosure:") or contains(text(), "rating =") or @align or preceding::p[contains(strong, "WARRANTY") or contains(strong, "Warranty") or contains(strong, "MANUAL") or contains(strong, "Verdict") or contains(strong, "Manual")] or contains(strong, "WARRANTY") or contains(strong, "MANUAL") or contains(strong, "VERDICT") or contains(strong, "Verdict") or contains(., "Check the "))]//text()').string(multiple=True)
    if not excerpt:
        excerpt = data.xpath('//div[article]/div/p[not(contains(em, "Disclosure:") or contains(text(), "rating =") or preceding::p[contains(strong, "WARRANTY") or contains(strong, "Warranty") or contains(strong, "MANUAL") or contains(strong, "Verdict") or contains(strong, "Manual")] or contains(strong, "WARRANTY") or contains(strong, "MANUAL") or contains(strong, "VERDICT") or contains(strong, "Verdict") or contains(., "Check the "))][@align="left"]//text()').string(multiple=True)
    if not excerpt:
