...
def process_revlist(data, context, session):
    last_rev_url = data.xpath('//li[@data-sorter="reviews"]//li[@class="post-list"]/a/@href').string()
...
def process_review(data, context, session):
    ...
    excerpt = data.xpath('//div[contains(@class, "clearfix")]/p//text()').string(multiple=True)
