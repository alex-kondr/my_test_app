...
def run(context, session):
    ...
    session.queue(Request('https://stereo.ru/tests', force_charset='utf-8'), process_revlist, dict())
...
def process_review(data, context, session):
    ...
    product.category = data.xpath('//a[contains(@class, "relation_channel")]/text()').string()
