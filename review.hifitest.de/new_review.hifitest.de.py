...
def run(context, session):
    ...
    session.queue(Request('https://www.hifitest.de/testberichte', use='curl'), process_revlist, dict())
...
def process_revlist(data, context, session):
    ...
    for rev in revs:
        ...
        session.queue(Request(url, use='curl'), process_review, dict(title=title, cats=cats, url=url))
