...
def process_reviews(data, context, session):
    ...
    for rev in revs:
        ...
        if title:
            review.title = title.replace('&#65533;', "'").replace('&#128513;', '').replace('&#127775;', '').replace('&#128514;', '').replace('&#128077;', '').replace('&#128512;', '').replace('&#128076;', '').replace('&#128525;', '').replace('&#65039;', '').replace('&#10084;', '').replace('&#128079;', '').replace('&#128522;', '').replace('&#128267;', '').replace('&#127996;', '').replace('&#128591;', '').replace('&#128588;', '').replace('&#127995;', '').replace('&#10004;', '').replace('&#128293;', '').replace('&#128562;', '').replace('&#128523;', '').replace('&#128526;', '').replace('&#128074;', '').replace('&#128176;', '').replace('&#127932;', '').replace('&#128266;', '').replace('&#127911;', '').replace('&#127867;', '').replace('&#129321;', '').replace('&#128540;', '').replace('&#9734;', '').replace('&#128264;', '').replace('&#127997;', '').replace('&#128175;', '').replace('&#128518;', '').replace('&#11088;', '').replace('&#128524;', '').replace('&#128516;', '').replace('&#129315;', '').replace('&#129304;', '').replace('&#128578;', '').replace('&#128515;', '').replace('&#128521;', '').replace('&#128378;', '').replace('&#127998;', '')
        ...
        if excerpt:
            excerpt = excerpt.replace('&#65533;', "'").replace('&#128513;', '').replace('&#127775;', '').replace('&#128514;', '').replace('&#128077;', '').replace('&#128512;', '').replace('&#128076;', '').replace('&#128525;', '').replace('&#65039;', '').replace('&#10084;', '').replace('&#128079;', '').replace('&#128522;', '').replace('&#128267;', '').replace('&#127996;', '').replace('&#128591;', '').replace('&#128588;', '').replace('&#127995;', '').replace('&#10004;', '').replace('&#128293;', '').replace('&#128562;', '').replace('&#128523;', '').replace('&#128526;', '').replace('&#128074;', '').replace('&#128176;', '').replace('&#127932;', '').replace('&#128266;', '').replace('&#127911;', '').replace('&#127867;', '').replace('&#129321;', '').replace('&#128540;', '').replace('&#9734;', '').replace('&#128264;', '').replace('&#127997;', '').replace('&#128175;', '').replace('&#128518;', '').replace('&#11088;', '').replace('&#128524;', '').replace('&#128516;', '').replace('&#129315;', '').replace('&#129304;', '').replace('&#128578;', '').replace('&#128515;', '').replace('&#128521;', '').replace('&#128378;', '').replace('&#127998;', '')
